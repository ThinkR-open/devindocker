...
A big project library may take some time and some place in your Docker container.
  + Using {devindocker}, these project specific packages are stored locally in the parent directory of your `project_path` by default, in a folder called `".renv"`. 
You can change it with parameter `renv_out_dir`. 
